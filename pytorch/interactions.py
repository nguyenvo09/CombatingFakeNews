...
def load_data(path, sep = '\t', header=None, dataset=None):
    ...
    user_ids = np.asarray(data[0]) # data type?
...
class Interactions(object):
    ...
    def __init__(self, user_ids, item_ids,
        ...
        # doing this is quite risky: if there are 4834 items but item with id 4833 may not appear in train
    ...
    def todok(self):
        """
        Transform to a scipy.sparse.dok_matrix CSR matrix.
        """
